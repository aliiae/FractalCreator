...
Controller::Controller(std::shared_ptr<Fractal> Fractal) : fractal_(std::move(Fractal)) {}
...
void Controller::zoomOut(Area<double> &NewArea, double WidthDelta, double HeightDelta) const {
...
void Controller::zoomIn(Area<double> &NewArea, double WidthDelta, double HeightDelta) const {
  NewArea.setXMin(NewArea.getXMin() + WidthDelta);
  NewArea.setXMax(NewArea.getXMax() - WidthDelta);
  NewArea.setYMin(NewArea.getYMin() + HeightDelta);
  NewArea.setYMax(NewArea.getYMax() - HeightDelta);
